...
const dtod = "6281511245024@s.whatsapp.net"
const otod = "6281511245024@s.whatsapp.net"
...
try {
        ...
        const grupinv = (teks) => {
        	grup = helga.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6281511245024-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IlpQRKWDZed0GgVHmYJUbl', "groupName": `${NamaBot}`, "footerText": "*_© Helga Zex_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
await helga.setStatus(`❄️Sc BY: wild | ⛈️Running Time : ${uptime}`).catch((_) => _);
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6281511245024-1616169743@g.us",
...
const daftar2 = '```Ketik Tombol Di Bawah Untuk Mendaftar Ke Database iwildbot```'
...
helga.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© iwildganz_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
⚠️ Segala kebijakan dan ketentuan iwildbot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu!
😖🙏
`
sendButLocation(from, `${menu}`, "*iwildbot*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`ping`,buttonText:{displayText:'SPEED BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'sc':
if (!isRegistered) return reply(`Registrasi Dulu Kak Ketik .verify`)
reply(`Saat ini Script Masih PRivate`)
break
     case 'allmenu':
  if (!isRegistered) return reply(`Registrasi Dulu Kak Ketik .verify`)
        ptod = "6281511245024@s.whatsapp.net"
        stod = `${sender}`
        yes = '```'
...
│◦➛ https://cararegistrasi.com/GRTX
│◦➛ https://bit.ly/GTXGROUP
│◦➛ https://instagram.com/officialgrowtopiartx
└❏  
...
╰────
`
sendButDocument(from, `${menu}`, "Big Thanks To\n\nAllah SWT\nMy Parrent\niwildbot\niwildganz\nAll Creator Bot Wa", fs.readFileSync('./helga.jpg'), {mimetype:Mimetype.pdf, thumbnail:ofrply, filename:`iwildbot`}, [{buttonId:`about`,buttonText:{displayText:'About 🐋'},type:1},{buttonId:`simple`,buttonText:{displayText:'Simple Menu 🐋'},type:1}], {quoted:fmen, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`IWILDBIT  Made By wildganz`,body:`𝙼𝚊𝚍𝚎 𝙱𝚢 𝙷𝚎𝚕𝚐𝚊`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/bF7K7KL7dVY`}}})
break
case 'simple':
 stod = `${sender}`
 listMsg = {
 buttonText: 'Simple Menu iwildbotz',
 footerText: '*iwild*',
 ...
 rows: [
                          {
                           ...
                           {
                              "title": "Owner Bot🐣",
                              "description": 'Owner Bot iwildbot!',
                              "rowId": ""
                           ...
                           {
                              "title": "Source Code⚠️",
                              "description": 'menampilkan sc dri bot wa ini',
                              "rowId": ""
...
🧶 https://chat.whatsapp.com/J6Ovd5XbK3J4AwZ00lZ31V

My Official Store⛱️

🧶 https://chat.whatsapp.com/BAFPNrsMw2AJC4lGmi0jAI

My Server⛱️

🧶 https://chat.whatsapp.com/CFPyhyJqpIeLYCuGzBtR3z
...
`
sendButDocument(from, `${menu}`, "SC: wildxyz\nSc Ini Sedang Dalam Tahap Pengembangan, Gunakan Bot Dengan Sebaik Mungkin!", fs.readFileSync('./helga.jpg'), {mimetype:Mimetype.pdf, thumbnail:ofrply, filename:`iwildbot 𝚅3.0.0`}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'Menu 🎋'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'Author 🍁'},type:1},{buttonId:`${prefix}gcbot`,buttonText:{displayText:'Group Bot 🎉'},type:1}], {quoted:fmen, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`IWILDBIT  Made By wildganz`,body:`𝙼𝚊𝚍𝚎 𝙱𝚢 𝙷𝚎𝚕𝚐𝚊`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/bF7K7KL7dVY`}}})
break
case 'bugreport':
...
case 'pornhub':
            ...
            reply (mess.wait)
              ...
              buttonsMessage = {footerText:'iwildbot', imageMessage: imageMsg,
              contentText:`iwildbot 𝙼𝚊𝚍𝚎 𝙱𝚢 iwild`,buttons,headerType:4}
...
case 'cecan':
            ...
            reply (mess.wait)
              ...
              imageMsg = (await helga.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'iwildbot', imageMessage: imageMsg,
              contentText:`Nih Kak!\nJangan Lupa Subscribe YT wildxyz`,buttons,headerType:4}
              prep = await helga.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              helga.relayWAMessage(prep)
              break                                           
...
case 'nsfw':
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						...
						helga.sendMessage(from, `iwildbot`, text)
...
katalog(menu)
sendButLocation(from, `Hai ${pushname} ☺️`, "*_© iwild.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa`,buttonText:{displayText:'SEWA 🎟️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'stopjadibot':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
try {
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await helga.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'IWILDBIT  Made By wildganz', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await helga.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              helga.relayWAMessage(prep)
...
case 'ppcp':
   ...
   if (!isRegistered) return reply(`Registrasi Dulu Kak Ketik .verify`)
			...
			buttons = [{buttonId: `!ytowner`,buttonText:{displayText: `wildganz`},type:1}]
